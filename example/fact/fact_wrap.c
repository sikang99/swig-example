...
_wrap_fact(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:fact int ",(void *)0) == TCL_ERROR) SWIG_fail;
...
_wrap_my_mod(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:my_mod n m ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
